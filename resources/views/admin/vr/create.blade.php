    ...
    <div class="form-container">
        ...
        <form action="{{ route('vr.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" class="form-control mb-3" placeholder="Enter vr title"
            ...
            <div>
                ...
                <input type="text" name="link" id="link" class="form-control mb-3" placeholder="Enter vr link"
            ...
            <div>
                ...
                <input type="file" name="image" id="image" class="form-control mb-3" placeholder="Upload VR image">
                @error('image')
                    <div class="custom-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit" class="btn btn-custom w-100">Add VR</button>
        </form>
